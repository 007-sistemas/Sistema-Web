...
import { Trash2, AlertTriangle, Fingerprint } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
           <h2 className="text-2xl font-bold text-gray-800">Gestão de Biometria</h2>
           <p className="text-gray-500">Cadastre ou remova digitais dos cooperados</p>
        </div>
      </div>
